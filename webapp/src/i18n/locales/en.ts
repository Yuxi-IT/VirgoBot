export default {
  ...
  loginPage: {
    title: 'Login',
    subtitle: 'Multi-channel AI assistant framework based on .NET 10',
  },
  auth: {
    login: 'Login',
    username: 'Username',
  ...
  skills: {
    title: 'Skills',
    subtitle: 'Skills are the core capability extension system of VirgoBot.',
    name: 'Name',
    ...
    restartHint: 'Changes take effect instantly (hot reload)',
    ...
    testSkillHint: 'Validate skill structure and check dependencies',
    dryRun: 'Dry Run',
    skillType: 'Type',
    singleSkill: 'Single',
    multiSkill: 'Multi',
    subSkillList: 'Sub-skills',
    addSubSkill: 'Add Sub-skill',
    subSkillsRequired: 'At least one sub-skill is required',
  },
  agent: {
    title: 'Agent Management',
    description: 'Go to the Agent page to create or import your AI assistant persona.',
    tip: 'You can customize character background, speaking style, and behavior patterns.',
  ...
  memory: {
    ...
    searchHint: 'Search or enter tags...',
  ...
  chatPage: {
    ...
    imageTooLargeDesc: 'Each image must be under {size}MB',
    imageMaxCount: 'Maximum {count} images allowed',
  },
  tasks: {
    ...
    messageCountTarget: 'Trigger Count',
    messageCountRole: 'Count Role',
    messageCountHint: 'Triggers when the specified role reaches the set message count, then resets',
    roleUser: 'User',
    roleAssistant: 'Assistant',
    messagesOf: 'messages from',
    onceTiming: 'Timing',
    onceDelay: 'Delay',
    onceAt: 'Specific Time',
    onceDelayMinutes: 'Delay Minutes',
    onceAtTime: 'Execution Time',
    onceHint: 'One-time tasks are automatically disabled after execution',
  ...
  onboarding: {
    ...
    step1: 'Welcome',
    step1Desc: 'Welcome to VirgoBot! Let\'s set up your personal AI assistant.',
    step2: 'Create Agent',
    step2Desc: 'Define your AI assistant\'s personality and role.',
    step3: 'Configure LLM',
    step3Desc: 'Set up the AI model provider and connection.',
    step4: 'Create Skill',
    step4Desc: 'Add skills to extend your assistant\'s capabilities.',
    step5: 'Test Chat',
    step5Desc: 'Try a conversation with your assistant.',
    step6: 'Explore Features',
    step6Desc: 'Discover auto-reply, voice chat, Telegram, and more.',
    skip: 'Skip',
    next: 'Next',
    back: 'Back',
    finish: 'Finish',
    completed: 'Onboarding completed',
    providersCompat: 'Supports OpenAI / Anthropic / Google Gemini compatible APIs.',
    skillsFormat: 'Supports JSON Skill (Shell/HTTP/Scrape/Multi) and SKILL.md standard format.',
    chatLocal: 'Try your first conversation with your AI assistant.',
    localDb: 'All conversations are saved in a local SQLite database.',
    feature1: 'Auto Reply — Proactively start conversations when idle',
    feature2: 'Voice Chat — Voice input and output',
    feature3: 'Telegram Channel — Interact via Telegram Bot',
    feature4: 'Scheduled Tasks — Automate periodic operations',
    feature5: 'MCP Integration — Connect to external tool services',
  },
  providers: {
    title: 'Provider Management',
    description: 'Configure LLM API connections in the Providers page.',
    addProvider: 'New Provider',
    editProvider: 'Edit Provider',
    noProviders: 'No providers yet, click top-right to create',
    ...
    apiKeyUnchanged: 'Leave empty to keep unchanged',
    ...
    modelCount: '{n} models',
    fetchModelsSuccess: 'Fetched {n} models',
    fetchModelsFailed: 'Failed to fetch models',
    modelSwitchSuccess: 'Switched model to {name}',
  ...
  security: {
    ...
    createSuccess: 'Access key created',
    deleteSuccess: 'Access key deleted',
    toggleSuccess: 'Access key status updated',
    keyCreated: 'Access Key Created',
    keyCreatedHint: 'Please copy the key now. It will not be shown again.',

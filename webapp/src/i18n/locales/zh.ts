export default {
  ...
  loginPage: {
    title: '登录',
    subtitle: '基于 .NET 10 的多通道 AI 助手框架',
  },
  auth: {
    login: '登录',
    username: '用户名',
  ...
  settings: {
    ...
    messageSplitDelimiters: '消息分割符',
    messageSplitDelimitersHint: '使用 | 分隔多个分割符，消息发送前会按这些分割符拆分',
    noAllowedUsers: '暂未配置允许的用户',
    save: '保存',
    voice: {
      tab: '语音',
      title: '语音功能配置',
  ...
  skills: {
    title: 'Skills',
    subtitle: 'Skills 是 VirgoBot 的核心能力扩展系统。',
    name: '名称',
    description: '描述',
    command: '命令',
    parameters: '参数',
    ...
    testSkillHint: '验证 Skill 结构和检测依赖项',
    dryRun: '仅预览',
    skillType: '类型',
    singleSkill: '单功能',
    multiSkill: '多子功能',
    subSkillList: '子功能列表',
    addSubSkill: '添加子功能',
    subSkillsRequired: '至少需要一个子功能',
  },
  agent: {
    title: '智能体管理',
    description: '前往设定页面，创建或导入你的 AI 助手人格。',
    tip: '你可以自定义角色背景、说话风格和行为模式。',
    current: '当前智能体',
    switchAgent: '使用此智能体',
  ...
  chatPage: {
    ...
    addImage: '添加',
    imageTooLarge: '图片超过大小限制',
    imageTooLargeDesc: '单张图片不能超过 {size}MB',
    imageMaxCount: '最多只能上传 {count} 张图片',
  },
  tasks: {
    title: '定时任务',
    ...
    once: '一次性',
    messageCount: '按对话轮数',
    messageCountTarget: '触发轮数',
    messageCountRole: '计数角色',
    messageCountHint: '当指定角色的消息达到设定轮数时触发任务，触发后计数器重置',
    roleUser: '用户',
    roleAssistant: '助手',
    messagesOf: '条消息来自',
    onceTiming: '执行时机',
    onceDelay: '延迟执行',
    onceAt: '指定时间',
    onceDelayMinutes: '延迟分钟数',
    onceAtTime: '执行时间',
    onceHint: '一次性任务执行完成后会自动关闭',
  ...
  onboarding: {
    title: '新手引导',
    step1: '欢迎',
    step1Desc: '欢迎使用 VirgoBot！让我们来设置你的个人 AI 助手。',
    step2: '创建设定',
    step2Desc: '定义你的 AI 助手角色和人格。',
    step3: '配置供应商',
    step3Desc: '设置 AI 模型供应商和连接。',
    step4: '创建 Skill',
    step4Desc: '添加技能来扩展助手的能力。',
    step5: '测试对话',
    step5Desc: '与你的助手进行第一次对话。',
    step6: '探索功能',
    step6Desc: '了解自动回复、语音对话、Telegram 等更多功能。',
    skip: '跳过',
    next: '下一步',
    back: '上一步',
    finish: '完成',
    completed: '引导已完成',
    providersCompat: '支持 OpenAI / Anthropic / Google Gemini 兼容的 API。',
    skillsFormat: '支持 JSON Skill（Shell/HTTP/Scrape/Multi）和 SKILL.md 标准格式。',
    chatLocal: '与你的 AI 助手进行第一次对话测试。',
    localDb: '所有对话记录都会保存在本地 SQLite 数据库中。',
    feature1: '自动回复 — 空闲时主动发起对话',
    feature2: '语音对话 — 语音输入和输出',
    feature3: 'Telegram 频道 — 通过 TG Bot 交互',
    feature4: '定时任务 — 自动化定期操作',
    feature5: 'MCP 集成 — 连接外部工具服务',
  },
  providers: {
    title: '供应商管理',
    description: '在供应商页面配置 LLM API 连接。',
    addProvider: '新建供应商',
    editProvider: '编辑供应商',
    noProviders: '暂无供应商，点击右上角创建',
    ...
    fetchModels: '获取模型列表',
    modelCount: '{n} 个模型',
    fetchModelsSuccess: '获取到 {n} 个模型',
    fetchModelsFailed: '获取模型列表失败',
    modelSwitchSuccess: '已切换模型为 {name}',
  ...
  security: {
    ...
    toggleSuccess: '密钥状态已更新',
    keyCreated: '密钥已创建',
    keyCreatedHint: '请立即复制密钥，关闭后将无法再次查看。',
    copied: '已复制到剪贴板',

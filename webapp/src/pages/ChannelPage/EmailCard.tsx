      ...
      <Card.Content>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div className="flex gap-4">
            <TextField variant="secondary" value={imapHost} onChange={onImapHostChange}>
              <Label>{t('channel.imapHost')}</Label>
              <Input />
            </TextField>

            <TextField variant="secondary" value={imapPort.toString()} onChange={(v) => onImapPortChange(parseInt(v) || 993)}>
          ...
          <div className="flex gap-4">
            <TextField variant="secondary" value={smtpHost} onChange={onSmtpHostChange}>
              <Label>{t('channel.smtpHost')}</Label>
              <Input />
            </TextField>

            <TextField variant="secondary" value={smtpPort.toString()} onChange={(v) => onSmtpPortChange(parseInt(v) || 587)}>
          ...
          <div className="flex gap-4">
            <TextField variant="secondary" value={address} onChange={onAddressChange}>
              <Label>{t('channel.emailAddress')}</Label>
              <Input />
            </TextField>

            <TextField variant="secondary" value={password} onChange={onPasswordChange}>
